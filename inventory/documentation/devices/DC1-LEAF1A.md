...
| -------------------- | ----------- | --- | ---------- | ------- |
| Management1 | oob_management | MGMT | 192.168.0.12/24 | 192.168.0.1 |
...
```eos
!
username admin privilege 15 role network-admin secret sha512 $6$x8MtobO1ifPGeY/q$HinQcYplQQjvAueXX4EWNU0J8CfbpuB86aV5tlMlh8zTAXkAYIV/6ETTZf6vT6ElQEGOuSMopNivYfRbc6m7O1
username arista privilege 15 role network-admin secret sha512 $6$x8MtobO1ifPGeY/q$HinQcYplQQjvAueXX4EWNU0J8CfbpuB86aV5tlMlh8zTAXkAYIV/6ETTZf6vT6ElQEGOuSMopNivYfRbc6m7O1
```
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | ------- | -------- | --- | ---------- | ------------ |
| Port-Channel1 | MLAG_PEER_DC1-LEAF1B_Po1 | 1500 | switched | trunk | 2-4094 | LEAF_PEER_L3<br> MLAG | - | - | - | - | - |
...
interface Port-Channel1
   description MLAG_PEER_DC1-LEAF1B_Po1
...
| --------- | ----------- | --- | ---- | ---- | --------------------- | ----------- | --- | ---------- | ---------------- | ------------------ |
| Ethernet1 | MLAG_PEER_DC1-LEAF1B_Ethernet1 | *1500 | *switched | *trunk | *2-4094 | *LEAF_PEER_L3<br> *MLAG | - | - | 1 | active |
| Ethernet2 | P2P_LINK_TO_DC1-SPINE1_Ethernet2 | 1500 | routed | access | - | - | - | 172.31.255.1/31 | - | - |
| Ethernet3 | P2P_LINK_TO_DC1-SPINE2_Ethernet2 | 1500 | routed | access | - | - | - | 172.31.255.3/31 | - | - |
...
!
interface Ethernet1
   description MLAG_PEER_DC1-LEAF1B_Ethernet1
